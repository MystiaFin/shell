...
ListView {
    ...
    function selectNext() {
        for (var i = currentIndex + 1; i < filterModel.items.count; i++) {
            if (!filterModel.items.get(i).inVisible) continue // Skip hidden
            currentIndex = i
            return
        }
    }
    ...
    DelegateModel {
        ...
        groups: [ DelegateModelGroup { name: "visible"; includeByDefault: true } ]
        ...
        function updateFilter() {
            ...
            for (var i = 0; i < items.count; i++) {
                ...
                var nameVal = (item.model.modelData && item.model.modelData.name) 
        ...
        delegate: Item {
            ...
            Row {
                ...
                Text {
                    text: modelData.name; color: "white"; font.bold: true; font.pixelSize: 14
